...
export default [
  {
    title: '34. hodina – Spojené nádoby',
    sourceLessonNo: 34,
    sourceUrl: 'https://drive.google.com/file/d/1JGhk_QA2ojO5sH7pky_55PrM-lB2uw15/view',
    date: '20. 2. 2023',
    content: R`<p><em>Procvičení hydrostatického tlaku a princip spojených nádob.</em></p>
<h3>Procvičení</h3>
<p>Příklad na hydrostatický tlak:</p>
