...
const PRESETS: PresetDef[] = [
  ...
  // F5-C: Dalších 8 kurikulárních scén
  {
    id: 'preset-galileo',
    icon: '🪨',
    title: 'Galilův pokus',
    description: 'Ocelová a pěnová koule ve vakuu — která dopadne dřív? Překvapivý výsledek!',
    badge: '6. ročník · Gravitace',
    makeScene: twoFallsScene,
  },
  {
    id: 'preset-kyvadla-delka',
    icon: '⏱️',
    title: 'Délka kyvadla',
    description: 'Dvě kyvadla různé délky — kratší závěs = kratší perioda kmitu.',
    badge: '8. ročník · Kmitání',
    makeScene: pendulumLengthScene,
  },
  {
    id: 'preset-vodorovny-vrh',
    icon: '🏹',
    title: 'Vodorovný vrh',
    description: 'Těleso vrženo vodorovně z výšky 5 m — předpověz vodorovný dostřel.',
    badge: '7. ročník · Pohyb',
    makeScene: horizontalThrowScene,
  },
  {
    id: 'preset-akce-reakce',
    icon: '↔️',
    title: 'Akce a reakce',
    description: 'Dvě tělesa stlačená pružinou — lehčí odletí rychleji (3. Newtonův zákon).',
    badge: '8. ročník · Síly',
    makeScene: newtonThirdScene,
  },
  {
    id: 'preset-moment-rovnovaha',
    icon: '🔧',
    title: 'Moment síly',
    description: '2 kg vlevo (1 m) a 1 kg vpravo (2 m) — páka zůstane v rovnováze!',
    badge: '9. ročník · Tuhé těleso',
    makeScene: momentBalanceScene,
  },
  {
    id: 'preset-restituce',
    icon: '🟢',
    title: 'Pružnost odrazu',
    description: 'Tři míče, tři koeficienty restituce — porovnej výšky odrazu.',
    badge: '7. ročník · Mechanika',
    makeScene: restitutionScene,
  },
  {
    id: 'preset-kruhovy-pohyb',
    icon: '🔄',
    title: 'Kruhový pohyb',
    description: 'Motor otáčí ramenem s koulí — pozoruj dostředivou sílu v FBD.',
    badge: '8. ročník · Pohyb',
    makeScene: circularMotionScene,
  },
  {
    id: 'preset-pad-ve-vzduchu',
    icon: '💨',
    title: 'Pád ve vzduchu',
    description: 'Těžká a lehká koule stejné velikosti ve vzduchu — Galilěův zákon nefunguje!',
    badge: '8. ročník · Odpor vzduchu',
    makeScene: airResistanceFallScene,
  },
];
