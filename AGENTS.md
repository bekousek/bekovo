...
- `src/content/osv-categories/**`, `src/content/osv-items/**`, `src/pages/osv/**`, `src/components/osv/**`, `src/lib/osv.ts`, `public/osv-soubory/**` (sekce OSV — osobnostní a sociální výchova; kurátoruje se ručně, viz [OSV.md](OSV.md))
